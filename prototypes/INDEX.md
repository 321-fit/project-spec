...
| `client-lists.html` | **Client lists** — `Clients \| Lists` pane, list detail (+ series attach), smart lists, create (multi-select), list chat, event picker with lists | bulk-select + set-of-people surfaces |
