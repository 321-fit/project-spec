...
.gr-proposed .gr-group .fit-input-group {
  margin-top: 0; margin-bottom: 0; padding: 9px 14px; position: relative;
...
.gr-proposed .gr-group .fit-input-label { font-size: 12px; font-weight: 400; color: var(--fit-text-tertiary); margin-bottom: 0; }
