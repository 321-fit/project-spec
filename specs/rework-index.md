...
3. Canvas hue per role (switch on every rework file, remembered per role): Teal is the brand; Indigo (evening / after-work, teal CTA + chips still pop, status pills keep contrast) is the proposed athlete variant; Ember (warm, but red/yellow pills lose contrast) and Graphite (neutral) are there to compare.
