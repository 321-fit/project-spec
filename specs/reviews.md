...
> - Backend: [poly-backend/docs/reviews-api.md](../../poly-backend/docs/reviews-api.md)
...
> ✅ **Backend reality (verified 2026-07-17, `origin/main`):** ratings + written reviews are **now shipped** — the greenfield build under epic **poly-backend#396** (quick-rating storage + aggregate #398/#399; athlete written-review CRUD #399; athlete-facing read #400) has landed on `main`. Canonical endpoint reference: [`poly-backend/docs/reviews-api.md`](../../poly-backend/docs/reviews-api.md). (Earlier drafts said "no `rating`/`review` table exists yet" — that is no longer true.)
